...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    void addContact(Aufgabe aufgabe) {
    ...
    public List<Aufgabe> getAllContacts() {
    ...
    public int updateContact(Aufgabe aufgabe) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteContact(Aufgabe aufgabe) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public String getmaxid(){
        String queryMaxID ="Select Max("+KEY_ID+") from "+TABLE_AUFGABE;
        SQLiteDatabase db=this.getReadableDatabase();
        Cursor y =db.rawQuery(queryMaxID,null);
